...
:: Prüfe ob axai-galaxy Ordner existiert
if not exist "axai-galaxy\" (
    echo Fehler: Der Ordner "axai-galaxy" wurde nicht gefunden!
...
set "ausgabedatei=axai-galaxy_Export_%datum%.txt"

:: Schreibe Kopfzeile
echo axai-galaxy Ordnerstruktur-Export erstellt am %date% um %time% > "%ausgabedatei%"
echo. >> "%ausgabedatei%"
echo ========== Dateiinhalte ========== >> "%ausgabedatei%"
echo. >> "%ausgabedatei%"

:: Durchlaufe alle Dateien rekursiv im axai-galaxy Ordner
for /r "axai-galaxy" %%F in (*) do (
